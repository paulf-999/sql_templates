...
GRANT CREATE TABLE, CREATE VIEW, CREATE EXTERNAL TABLE, CREATE MATERIALIZED VIEW, CREATE PROCEDURE, CREATE TASK ON ALL SCHEMAS IN DATABASE &{PROGRAM}_DQ_DB TO ROLE &{PROGRAM}_DATA_LOADER;
GRANT CREATE TABLE, CREATE VIEW, CREATE EXTERNAL TABLE, CREATE MATERIALIZED VIEW, CREATE PROCEDURE, CREATE TASK ON FUTURE SCHEMAS IN DATABASE &{PROGRAM}_DQ_DB TO ROLE &{PROGRAM}_DATA_LOADER;
